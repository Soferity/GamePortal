class Game {
    ...
    generateTweet() {
        ...
        let uri = new URL("https://twitter.com/intent/tweet?url=https://github.com/Soferity/GamePortal&text=" + String.format(this.tweettext, this.score) + "&hashtags=soferity,gameportal,coloron&via=iTaiizor")
    ...
    start() {
        ...
        Taiizor.Storage.Local.Set('coloron', 'play');
